...
- Because equilibrium vapor pressure of the volatile species (S$_2$, Pb) changes by orders of magnitude across the homogeneity range, **the partial pressure of sulfur maintained over the charge during growth is the primary practical handle** for controlling n- or p-type conduction and carrier concentration — this is the same physical principle used in nonstoichiometry-controlled MBE and vapor growth of other IV–VI compounds (PbTe, PbSe).
