...
- **Ambient**: reducing ($\text{H}_2$), inert (Ar, $\text{N}_2$), or component-overpressure atmospheres are chosen according to which defect chemistry is being targeted (void dissolution vs. stoichiometry/compensation).
