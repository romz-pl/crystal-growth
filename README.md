...
+ [Liquid-Encapsulated Czochralski (LEC) Method](./doc/method-liquid-encapsulated-czochralski.md)
+ [Magnetic Czochralski (MCZ) Method](./doc/method-magnetic-czochralski.md)
+ [Electromagnetic Czochralski (EMCZ) Method](./doc/method-electromagnetic-czochralski.md)
...
+ **Li You-Rong** — Chongqing University; collaborator with Imaishi on global Czochralski furnace simulation and thermocapillary convection, [Bibliography](./doc/bibliography-li.md), [Bio](./doc/bio-li.md).
+ **Liu Xuan** — Tohoku University (Kakimoto group); transient global modeling of the CZ silicon pulling process and carbon-contamination modeling, [Bibliography](./doc/bibliography-liu.md), [Bio](./doc/bio-liu.md).
+ **Makarov Yuri N.** — co-developer of modeling methodologies for melt turbulence and gas-flow effects on Czochralski heat transport; co-founder of STR Group/Nitride Crystals, [Bibliography](./doc/bibliography-makarov.md), [Bio](./doc/bio-makarov.md).
...
+ **Vizman Daniel** — West University of Timisoara, Romania, [Bibliography](./doc/bibliography-vizman.md), [Bio](./doc/bio-vizman.md).
+ **Wilcox William R.** — Clarkson University; classical numerical/analytical treatment of segregation, convection, and interface stability in melt growth, [Bibliography](./doc/bibliography-wilcox.md), [Bio](./doc/bio-wilcox.md).
+ **Zhmakin Alexander I.** — Ioffe Institute, St. Petersburg; large-eddy simulation of melt convection and broader numerical simulation of crystal growth transport phenomena, [Bibliography](./doc/bibliography-zhmakin.md), [Bio](./doc/bio-zhmakin.md).
+ **Yeckel Andrew** — author of Cats2D, [Bibliography](./doc/bibliography-ayeckel.md), [Bio](./doc/bio-ayeckel.md).
...
+ [Code_saturne and Code_Aster and SYRTHES](./doc/software-code_saturne-code_aster-syrthes.md)
...
+ [**Si**](./doc/material-si.md)
+ [**Ge**](./doc/material-ge.md)
+ [**GaAs**](./doc/material-gaas.md)
+ [**GaP**](./doc/material-ga-p.md)
+ [**GaSb**](./doc/material-ga-sb.md)
+ [**InAs**](./doc/material-in-as.md)
+ [**InP**](./doc/material-inp.md)
+ [**InSb**](./doc/material-in-sb.md)
+ [**AlAs**](./doc/material-al-as.md)
+ [**AlP**](./doc/material-al-p.md)
+ [**AlSb**](./doc/material-al-sb.md)
+ [**ZnS**](./doc/material-zn-s.md)
+ [**ZnSe**](./doc/material-zn-se.md)
+ [**ZnTe**](./doc/material-zn-te.md)
+ [**CdS**](./doc/material-cd-s.md)
+ [**CdSe**](./doc/material-cd-se.md)
+ [**CdTe**](./doc/material-cd-te.md)
+ [**PbS**](./doc/material-pb-s.md)
+ [**PbSe**](./doc/material-pb-se.md)
